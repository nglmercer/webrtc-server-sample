 ...
 */
export function getHeartbeatConfig(environment) {
    return HeartbeatConfigs[environment];
}
/**
 * Crea una configuración personalizada basada en una configuración base
 */
export function createCustomHeartbeatConfig(baseConfig, overrides) {
    return {
 ...
 */
export function getHeartbeatConfigFromEnv() {
    const config = {};
