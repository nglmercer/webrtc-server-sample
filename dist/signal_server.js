...
import { handleDisconnect, setupHeartbeat, getSocketStats } from "./utils/socketUtils.js";
...
import { defaultHeartbeatManager, getHeartbeatConfig } from "./heartbeat/index.js";
...
export class SignalingServer {
    ...
    handleConnection(socket) {
        ...
        let params = customSocket.handshake.query;
        ...
        customSocket.on("disconnect", handleDisconnect(customSocket, this.listOfRooms, this.listOfUsers, autoCloseEntireSession, this.config));
     ...
     */
    setupHeartbeatManager(heartbeatConfig) {
        try {
            // Usar configuración del entorno si está disponible
            const envConfig = process.env.NODE_ENV ? getHeartbeatConfig(process.env.NODE_ENV) : getHeartbeatConfig('production');
            const finalConfig = {
                ...envConfig,
                ...heartbeatConfig
            };
...
//# sourceMappingURL=signal_server.js.map